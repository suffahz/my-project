                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('teacher.register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="subject_specialty" type="text" class="form-control @error('subject_specialty') is-invalid @enderror" name="subject_specialty" value="{{ old('subject_specialty') }}" required>
